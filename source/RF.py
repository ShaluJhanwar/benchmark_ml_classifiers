...
def main(argv):
        ...
        data_file = "/nfs/users/so/sjhanwar/ML_tool/Resources/ManuscriptFiles/Genome_Epigenome_model_data/All_epigenome.txt" #Epigenome (with tss)
        out_folder ="/nfs/users/so/sjhanwar/ML_tool/Resources/ManuscriptFiles/Genome_Epigenome_model_data/test"
        label_col = 1
        ...
        filename = out_folder + "/All_epigenome.pkl"
        joblib.dump(estimator, filename, compress=9)
        #2nd genomic feature
        data_file2 = "/nfs/users/so/sjhanwar/ML_tool/Resources/ManuscriptFiles/Genome_Epigenome_model_data/All_genome.txt"
...
#print "Best parameters are for the second: max_depth =",best_max_depth2, "n_estimator:", best_n_estimators2, '\n'
        ...
        filename2 = out_folder + "/Genome_feature.pkl"
        ...
        rf_combined = combine_rfs(estimator, estimator2)
        print "For combine model\n"
        #print rf_combined.estimators_, "\n"
        print rf_combined.feature_importances_, "\n"
        filename3 = out_folder + "/combined_Epigenome_Genome_RF_model.pkl"
        joblib.dump(rf_combined, filename3, compress=9)
...
def grid_searchCV(cv, X_train, y_train):
    max_depth=np.linspace(1,20,10) #By default
